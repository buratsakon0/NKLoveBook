...
<div class="max-w-md mx-auto mt-10 bg-white p-8 rounded-xl shadow">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <button class="w-full bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700">เข้าสู่ระบบ</button>
    </form>

    <p class="text-center mt-4 text-sm">ยังไม่มีบัญชี? 
        <a href="{{ route('register') }}" class="text-indigo-600 hover:underline">สมัครที่นี่</a>
    </p>
</div>
@endsection
