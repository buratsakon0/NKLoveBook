@extends('layouts.app') {{-- ใช้ layout เดียวกับหน้าอื่น เช่น home.blade.php --}}
...
<div class="container mx-auto my-12 px-4">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <img src="{{ asset('images/bookshelf.jpg') }}" alt="Books" class="w-full h-72 object-cover">
        ...
        <div class="p-8">
            ...
            <p class="text-blue-700">Contacts@Gmail.Com</p>
        </div>
    </div>
</div>
@endsection
